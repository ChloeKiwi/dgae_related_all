...
class Quantizer(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        # # distance3:cosine距离
        # x_normalized = F.normalize(x_flat_detached, p=2, dim=-1)  # L2归一化
        # embedding_normalized = F.normalize(self.embedding, p=2, dim=-1)  # L2归一化
        # distances = 1 - torch.sum(x_normalized.unsqueeze(2) * embedding_normalized.unsqueeze(0), -1)
