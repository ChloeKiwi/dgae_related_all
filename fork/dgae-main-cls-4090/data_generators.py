...
def generate_dataset(data_dir='data', dataset='community_small'):
    ...
    if dataset == 'community_small':
        ...
        graphs = citeseer(radius=2, node_min=4, node_max=18)
        ...
        save_dataset(data_dir, graphs, 'PROTEINS_full_feat')
        print(max([g.number_of_nodes() for g in graphs]))
    
    elif dataset == 'citeseer':
        import ipdb; ipdb.set_trace()
        # graphs = citeseer(radius=1, node_min=3, node_max=18)
        graphs = citeseer(radius=2, node_min=3, node_max=18)
