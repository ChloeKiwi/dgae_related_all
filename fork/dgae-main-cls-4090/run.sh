...
# exp_name='enzymes_cls'
# run_name='cls_acc_test'
# run_name='cls_acc_test_complex_head'
# run_name='no_cls_loss'

exp_name='citeseer_cls'
# run_name='cls_acc_test_complex_head'
# run_name='cls_acc_test_complex_head_no_augment'
run_name='no_cls_no_augment'
