...
def parse_log_file(file_path):
    ...
    return dataset, experiment, generation_time, metrics, metrics_novel_unique

def generate_latex_table(dataset, experiment, generation_time, metrics, metrics_novel_unique):
    latex = "\\begin{table}[h]\n\\centering\n\\begin{tabular}{|l|c|}\n\\hline\n"
...
def process_result(log_dir):
    ...
    dataset, experiment, generation_time, metrics, metrics_novel_unique = parse_log_file(log_file_path)
    latex_table = generate_latex_table(dataset, experiment, generation_time, metrics, metrics_novel_unique)
    # 创建输出目录（如果不存在）
