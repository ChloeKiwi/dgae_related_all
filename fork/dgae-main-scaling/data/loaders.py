...
class FromNetworkx(InMemoryDataset):
    def __init__(self, root, dataset=None, transform=None, pre_transform=None, pre_filter=None):
        ...
        torch.load(self.processed_paths[0])
        self.data, self.slices = torch.load(self.processed_paths[0])
        # self.mark_structural_equivalence()
    ...
    def raw_file_names(self):
        ...
        elif self.dataset == 'community_200':
            return ['community_200.pkl']
        elif self.dataset == 'community_500':
            return ['community_500.pkl']
        elif self.dataset == 'community_1000':
            return ['community_1000.pkl']
        elif self.dataset == 'community_2000':
            return ['community_2000.pkl']
    ...
    def processed_file_names(self):
        if self.dataset == 'ego':
            ...
            return ['community_200.pt']
        elif self.dataset == 'community_500':
            return ['community_500.pt']
        elif self.dataset == 'community_1000':
            return ['community_1000.pt']
        elif self.dataset == 'community_2000':
            return ['community_2000.pt']
        elif self.dataset == 'enzymes':
            return ['ENZYMES.pkl']
        elif self.dataset == 'grid':
            # return ['grid_data.pt']
    ...
    def process(self):
        ...
        for g in graph_list:
            ...
            elif self.dataset == 'community' or self.dataset == 'community_200' or self.dataset == 'community_500' or self.dataset == 'community_1000' or self.dataset == 'community_2000':
