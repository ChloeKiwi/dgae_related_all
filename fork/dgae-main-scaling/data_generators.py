...
def generate_dataset(data_dir='data', dataset='community_small'):
    ...
    if dataset == 'community_small':
        ...
        res_graph_list = gen_graph_list(graph_type='community', possible_params_dict={
                                        'num_communities': [2],
                                        'max_nodes': np.arange(12, 21).tolist()},
                                        corrupt_func=None, length=200, save_dir=data_dir, file_name='community_200') #! only 100 graphs
        res_graph_list = gen_graph_list(graph_type='community', possible_params_dict={
                                        'num_communities': [2],
                                        'max_nodes': np.arange(12, 21).tolist()},
                                        corrupt_func=None, length=500, save_dir=data_dir, file_name='community_500') #! only 100 graphs
        res_graph_list = gen_graph_list(graph_type='community', possible_params_dict={
                                        'num_communities': [2],
                                        'max_nodes': np.arange(12, 21).tolist()},
                                        corrupt_func=None, length=1000, save_dir=data_dir, file_name='community_1000') #! only 100 graphs
        res_graph_list = gen_graph_list(graph_type='community', possible_params_dict={
                                        'num_communities': [2],
                                        'max_nodes': np.arange(12, 21).tolist()},
                                        corrupt_func=None, length=2000, save_dir=data_dir, file_name='community_2000') #! only 100 graphs
        ...
        graphs = graph_load_batch(min_num_nodes=10, max_num_nodes=500, name=dataset,
