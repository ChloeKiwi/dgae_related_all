...
# for i in {1..5}
# do
#     echo "Running sample $i of 5..."
#     python main.py --work_type sample --gpu $gpu --exp_name $exp_name --dataset $dataset --use_mask 2>&1 | tee "models_own/$exp_name/${dataset}_sample/${date}_run$i.log"
#     echo "Completed sample $i of 5"
...
#     fi
# done
# echo "All sampling runs completed!"