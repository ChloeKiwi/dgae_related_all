...
def main() -> None:
    ...
    print(f"exp_name: {config.exp_name}, run_name: {config.run_name}, dataset: {args.dataset}, use_mask: {args.use_mask}, cb_size:{config.model.quantizer.codebook_size}, nc:{config.model.quantizer.nc}, wandb:{config.log.wandb}")
