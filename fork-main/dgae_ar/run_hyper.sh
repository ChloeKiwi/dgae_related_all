...
declare -A experiment_configs=(
    ['enzymes_cb1024_1']='enzymes 1024 1 0'
    ['enzymes_cb512_1']='enzymes 512 1 1'
    # ['qm9_cb128_1']='qm9 128 1 0'
    # ['community_cb16_2']='community 16 2 1'
    # ['community_cb16_2_no_sort']='community 16 2 1'
    # ['community_cb16_2_no_pe']='community 16 2 2'
    # ['community_cb16_2_no_sort_no_pe']='community 16 2 3'
    # ["community_cb128_1"]="community 128 1 2"    # 新格式: "dataset codebook_size nc gpu"
    # ["community_cb64_1"]="community 64 1 0"    # 新格式: "dataset codebook_size nc gpu"
    # ["community_cb32_2"]="community 32 2 0"
    # ["community_cb64_2"]="community 64 2 1"
    # ["community_cb256_1"]="community 256 1 1"
    # ["sample_plot_indices"]="community 16 2 1"
    # ["sample_plot_indices_256_1"]="community 256 1 2"
    # ["sample_plot_indices_128_1"]="community 128 1 2"
    # ['sample_plot_indices_no_pe']="community 16 2 3"
    # grid数据集的配置
    # ["grid_cb64_2"]="grid 64 2 0"
    # ["grid_cb128_2"]="grid 128 2 1"
    # ["grid_cb256_2"]="grid 256 2 2"
