...
--work_type train_autoencoder: train the GNN encoder, quantizer, and decoder at first stage.

--work_type train_prior: train the transformer at the 'mask graph training' stage.
