...
This repository contains the source code for the , a powerful autoencoder for graph data that uses vector quantization to learn discrete representations.
