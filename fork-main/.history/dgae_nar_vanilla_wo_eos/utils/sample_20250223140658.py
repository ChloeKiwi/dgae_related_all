...
def sample_batch(n_samples, transformer, quantizer, decoder, wandb, iterations=None, mask_func=None):
    with torch.no_grad():
        ...
        zq, node_masks, indices = sample_prior_nar_vanilla_wo_eos(n_samples, transformer, quantizer, wandb, iterations=iterations, mask_func=mask_func)
