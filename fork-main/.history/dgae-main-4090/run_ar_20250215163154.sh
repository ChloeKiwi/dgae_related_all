...
declare -A experiment_configs=(
    ['community_16_1']='community 16 1 0'
    ['community_32_1']='community 32 1 1'
...
run_experiment() {
    ...
    #     return 1
    # fi
    python main.py --work_type train_autoencoder --gpu $gpu --exp_name $exp_name --run_name $exp_config \
        --dataset $dataset --wandb $wandb --codebook_size $codebook_size --nc $nc 2>&1 | tee "models_own/$exp_name/$exp_config/${dataset}_autoencoder/$date.log"
