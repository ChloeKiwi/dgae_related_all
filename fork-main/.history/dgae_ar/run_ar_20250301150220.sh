...
declare -A experiment_configs=(
    ...
    # ['grid']='grid 128 2 1'
    # ['grid_512_1']='grid 512 1 0'
    # ['protein_1024_1']='protein 1024 1 3'
    # ['protein_512_1']='protein 512 1 3'
    # ['grid_1024_1']='grid 1024 1 3'
    # ['enzymes_cb512_1']='enzymes 512 1 1'
    # ['qm9']='qm9 128 1 1'
    # ['zinc']='zinc 128 1 1'
    # ['ego']='ego 16 1 0'
    # ['planar_64_1']='planar 64 1 0'
    # ['planar_256_1']='planar 256 1 0'
    # ['planar_512_1']='planar 512 1 3'
    # ['planar_512_1']='planar 512 1 3'
    ['planar_512_1_large']='planar 512 1 3'
    # ['sbm_512_1']='sbm 512 1 2'
    # ['sbm_1024_1']='sbm 1024 1 0'
)
