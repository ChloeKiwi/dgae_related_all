    ...
    def __init__(self, dataloaders, config, data_info):
        ...
        if config.work_type != 'sample':
            ...
            with wandb.init(project=project, config=config, mode=config.log.wandb, 
                ...
                config.model.decoder.n_layers=sweep_config.model.decoder.n_layers
                config.model.decoder.nhf=sweep_config.model.decoder.nhf
                config.model.decoder.mlp_hidden_size=sweep_config.model.decoder.mlp_hidden_size
                config.model.decoder.mlp_n_layers=sweep_config.model.decoder.mlp_n_layers
