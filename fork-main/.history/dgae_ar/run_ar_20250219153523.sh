...
# resume_from='./models_own/$exp_name/$run_name/${dataset}_prior/best_run_epoch_avg.pth'


# 定义实验配置，现在包含数据集信息
declare -A experiment_configs=(
    # ['community_16_1']='community 16 1 1'
    # ['community_32_1']='community 32 1 3'
    # ['community_64_1']='community 64 1 0'
    # # ['community_128_1']='community 128 1 0'
    # ['community_256_1']='community 256 1 1'
    # ['community_1024_1']='community 1024 1 2'
    # ['community_512_1']='community 512 1 2'
    ['grid_cb128_2']='grid 128 2 1'
    # ['grid_512_1']='grid 512 1 2'
    # ['grid_1024_1']='grid 1024 1 3'
)
...
run_experiment() {
    ...
    resume_path = "models_own/$exp_name/$exp_config/${dataset}_prior/best_run_epoch_avg.pth"
    ...
    python main.py --work_type train_prior --gpu $gpu --exp_name $exp_name --run_name $exp_config --dataset $dataset --wandb $wandb --codebook_size $codebook_size --nc $nc --resume_from "models_own/$exp_name/$exp_config/${dataset}_prior/best_run_epoch_avg.pth" 2>&1 | tee "models_own/$exp_name/$exp_config/${dataset}_prior/$date.log"
