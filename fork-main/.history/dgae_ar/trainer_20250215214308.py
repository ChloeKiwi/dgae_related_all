...
class Trainer:
    def __init__(self, dataloaders, config, data_info):
        ...
        self.save_dir = f'./models_own/{self.config.exp_name}/{self.config.run_name}/{self.config.dataset}_autoencoder'
        os.makedirs(self.save_dir, exist_ok=True)
        self.save_path = os.path.join(self.save_dir, f'{self.config.dataset}_autoencoder.pt')
