...
class Trainer:
    def __init__(self, dataloaders, config, data_info):
        ...
        if config.work_type != 'sample':
            ...
            exp_dir = f'./models_own/{self.config.exp_name}/{self.config.run_name}/{self.config.dataset}_{work_type}'
    ...
    def save_config(self,config_path,save_dir):
        ...
        additional_config = {
            ...
            'device':{'value':self.config.device},
