...
def get_dataset(dataset: str, config: EasyDict) -> Tuple[List[DataLoader], EasyDict, EasyDict]:
    ...
    elif dataset == 'ego' or dataset == 'community' or dataset == 'enzymes' or dataset == 'grid' or dataset == 'grid_1k' or dataset == 'protein' or dataset == 'citeseer' or dataset == 'community_ego' or dataset == 'circular_ladder' or dataset == 'cycle' or :
        # Choose the appropriate transforms based on the dataset and configuration
        transforms = []
