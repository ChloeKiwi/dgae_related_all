...
def sample(n_sample, transformer, quantizer, decoder, wandb, max_node_num=None, mask_func=None):
    if n_sample <= 1000:
        return sample_batch(n_sample, transformer, quantizer, decoder, wandb, max_node_num, mask_func)
    else:
        K = (n_sample // 1000)
        mod = n_sample % 1000
