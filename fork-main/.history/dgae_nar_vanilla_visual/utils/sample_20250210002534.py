...
#     # 1 (非mask位置) -> 白色
#     # 0 (mask位置) -> 蓝色
#     plt.imshow(~mask.bool().cpu().numpy(), cmap='Blues')  # 取反使得mask位置显示为蓝色
    
#     plt.colorbar()
#     plt.title('Mask Visualization\n(Blue: masked, White: unmasked)')
