        ...
        for epoch in tqdm(range(1, self.epochs)):
            ...
            for batch in self.train_loader:
                ...
                if step % self.n_logging_steps == 0:
                    ...
                    annots, adjs, indices = sample_batch(self.n_samples, self.transformer, self.quantizer, self.decoder, self.max_node_num, self.config.mask_func)
            ...
            if epoch % self.n_logging_epochs == 0:
                ...
                annots, adjs, indices = sample(self.n_samples, self.transformer, self.quantizer, self.decoder, self.max_node_num, self.config.mask_func)
                if self.mol_data:
